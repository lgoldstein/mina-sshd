...
/**
 * <UL>
 *      <LI>Ported from C to Java by Dmitry Skiba [sahn0], 23/02/08.</LI>
 *      <LI>Original: http://cds.xs4all.nl:8081/ecdh/</LI>
 *      <LI>Generic 64-bit integer implementation of Curve25519 ECDH</LI>
 *      <LI>Written by Matthijs van Duin, 200608242056</LI>
 *      <LI>Public domain.</LI>
 *      <LI>Based on work by Daniel J Bernstein, http://cr.yp.to/ecdh.html</LI>
 * </UL>
 * @author <a href="mailto:dev@mina.apache.org">Apache MINA SSHD Project</a>
 * @see <a href="https://raw.githubusercontent.com/hierynomus/sshj/master/src/main/java/djb/Curve25519.java">SSHJ code</A>
 */
public class Curve25519 {
    ...
    /**
     * @return All zero value
     */
    public static byte[] getZeroValue() {
        return ZERO.clone();
    }

    /**
     * @return The prime {@code 2^255-19}
     */
    public static byte[] getPrimeValue() {
        return PRIME.clone();
    }

    /**
     * @return Group order (a prime near {@code 2^252+2^124})
     */
    public static byte[] getGroupOrderValue() {
        return ORDER.clone();
    }
